...
namespace KatlaSport.Services.HiveManagement
{
    ...
    public interface IHiveSectionService
    {
        ...
        /// <summary>
        /// Creates a new hive section asynchronously.
        /// </summary>
        ...
        /// <summary>
        /// Updates an existed hive section asynchronously.
        /// </summary>
        /// <param name="hiveSectionId">A hive section identifier.</param>
        ...
        /// <param name="hiveSectionId">A hive section identifier.</param>
        /// <returns>
        /// A <see cref="Task{Hive}"/> that represents the asynchronous operation.
        /// </returns>
